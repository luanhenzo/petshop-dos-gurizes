 ...
 * @author luansinh0
 */
public class FrmEnderecosCliente extends javax.swing.JFrame {

    /** Creates new form FrmEnderecosClientes */
    public FrmEnderecosCliente() {
        initComponents();
    ...
    private void initComponents() {
        ...
        JpnIdLayout.setHorizontalGroup(
            ...
            .addGroup(JpnIdLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(JtfId, javax.swing.GroupLayout.DEFAULT_SIZE, 372, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmEnderecosCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
